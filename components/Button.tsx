...
const Button = ({
  ...
  return (
    <div
      className={clsx(
        "button-cutout group mx-4 inline-flex items-center bg-linear-to-b from-25% to-75% bg-size-[100%_400%] font-bold transition-[filter,background-position] duration-300 hover:bg-bottom cursor-pointer",
        size === "sm" && "gap-2.5 py-2 text-base",
        size === "md" && "gap-3 px-1 py-2.5 md:py-3 text-lg",
        size === "lg" &&
          "gap-3 md:gap-4 px-1 md:px-2 py-3 md:py-4 text-lg md:text-xl lg:text-2xl",
        color === "orange" &&
